/*  
   ...
   Project 3
   11/27/2020
  File discerption: Define Parse tree grammar and syntactic analyzer
   */
...
%token <value> INT_LITERAL DOUBLE_LITERAL REAL_LITERAL BOOL_LITERAL CASE TRUE FALSE
%token <oper> ADDOP MULOP RELOP OROP NOTOP REMOP EXPOP
%token ANDOP 
%token BEGIN_ BOOLEAN END ENDREDUCE FUNCTION INTEGER DOUBLE IS REDUCE RETURNS
%token THEN WHEN 
...
parameter:
	IDENTIFIER ':' type {symbols.insert($1, parameters[0]);} ;
